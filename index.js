...
import { PrismaClient } from './generated/prisma/index.js'; // ensure correct path and .js extension if using ESM
...
import MailMessage from 'nodemailer/lib/mailer/mail-message.js'; // use .js if necessary in ESM
